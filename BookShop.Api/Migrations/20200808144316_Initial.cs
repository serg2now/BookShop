        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Author = table.Column<string>(type: "NVarchar(70)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAdress = table.Column<string>(type: "NVarchar(150)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAdress = table.Column<string>(type: "NVarchar(200)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(nullable: false),
                    DeviceName = table.Column<string>(type: "NVarchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshToken_DeviceName_UserId",
                table: "RefreshToken",
                columns: new[] { "DeviceName", "UserId" },
                unique: true);
